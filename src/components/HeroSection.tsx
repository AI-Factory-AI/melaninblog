...
const HeroSection = () => {
  return (
    <section
      className="relative min-h-[560px] md:min-h-[680px] lg:min-h-[760px] bg-cover bg-center bg-no-repeat"
      style={{ backgroundImage: `url(${heroImage})` }}
    >
      <div className="absolute inset-0 bg-gradient-to-t from-foreground/90 via-foreground/50 to-foreground/20" />
      <div className="relative container mx-auto px-6 lg:px-8 pt-28 pb-40 md:pt-36 md:pb-44 lg:pt-44 lg:pb-48 min-h-[560px] md:min-h-[680px] lg:min-h-[760px] flex items-end">
        <motion.div
